...
local function check_member_super(cb_extra, success, result) 
  ...
  if success == 0 then 
    send_large_msg(receiver, "لا تلعب بكيفك 😠للادمن بس") 
  end 
...
local function lock_group_spam(msg, data, target) 
  ...
  if not is_owner(msg) then 
    return "عزيزي \n "..msg.from.first_name.." \n لايمكنك تحكم في البوت للادمن  فما فوق😇" 
  end 
  ...
  if group_spam_lock == 'yes' then 
    ...
    save_data(_config.moderation.data, data) 
    return 'تم قفل🔒 مضاد السبام☑ lياl~['..msg.from.first_name..']".."\nمعرفك: '..msg.from.username..' \n ' 
  end 
end 
...
local function set_rulesmod(msg, data, target) 
  ...
  save_data(_config.moderation.data, data) 
  return 'تم ️ وضع القوانين 📋 في المجموعه '..msg.to.title..'\n ' 
end 
...
local function get_rules(msg, data) 
  ...
  if not data[tostring(msg.to.id)][data_cat] then 
    return 'لم يتم  وضع القوانين 📋 في المجموعه '..msg.to.title..'\n' 
  end 
...
local function set_public_membermod(msg, data, target) 
  if not is_momod(msg) then 
    return "عزيزي \n '..msg.from.username..' \n لا يمكنك تحكم بل بوت للادمن فما فوق\n " 
  end 
...
local function promote_admin(receiver, member_username, user_id) 
  ...
  if data[group]['moderators'][tostring(user_id)] then 
    return send_large_msg(receiver, member_username..'هوه بالفعل ☑️ادمن في مجموعه\n '..msg.to.title..'\n ') 
  end 
...
local function demote_admin(receiver, member_username, user_id) 
  ...
  if not data[group]['moderators'][tostring(user_id)] then 
    return send_large_msg(receiver, member_tag_username..'هوه بالفعل ☑️ادمن في مجموعه\n '..msg.to.title..'\n') 
  end 
...
local function promote2(receiver, member_username, user_id) 
  ...
  local member_tag_username = string.gsub(member_username, '@', '(at)') 
  if not data[group] then 
    return send_large_msg(receiver, 'المجموعه  ليست فعاله️') 
  end 
  if data[group]['moderators'][tostring(user_id)] then 
    return send_large_msg(receiver, member_username..'هوه بالفعل ☑️ادمن في مجموعه \n '..msg.to.tite..'\n') 
  end 
  data[group]['moderators'][tostring(user_id)] = member_tag_username 
  save_data(_config.moderation.data, data) 
  send_large_msg(receiver, member_username..'وتم رفعته ادمن 😆صير حبايب ومع روابط😅😆') 
end 
...
local function demote2(receiver, member_username, user_id) 
  ...
  data[group]['moderators'][tostring(user_id)] = nil 
  save_data(_config.moderation.data, data) 
  send_large_msg(receiver, member_username..'   تم ☑️ نزلته خطيه هسه يبجي₩') 
end 
...
local function modlist(msg) 
  ...
  if next(data[tostring(msg.to.id)]['moderators']) == nil then 
    return 'لا يوجد ⚠️ ادمنيه حاليا ️' 
  end 
  local i = 1 
...
function get_message_callback(extra, success, result) 
    ...
    if is_momod2(member_id, channel_id) and not is_admin2(msg.from.id) then 
               return send_large_msg("channel#id"..channel_id, "❌ لا يمكنك طرد الاداره ،الادمن فما فوق♡") 
    end 
    ...
    if is_admin2(member_id) then 
         return send_large_msg("channel#id"..channel_id, "❌ لا يمكنط رد الاداره، الادمن فما فوق") 
    end 
    ...
    elseif get_cmd == "رفع اداري" then 
        ...
        if result.from.username then 
            text = "@"..result.from.username.."   تم ☑️ رفعك 😉 في اداره البوت  " 
        else 
            text = "[ "..user_id.." ]   تم ☑️ رفعك 😉 في اداره البوت " 
        end 
    ...
    elseif get_cmd == "تنزيل اداري" then 
        ...
        if is_admin2(result.from.peer_id) then 
            return send_large_msg(channel_id, "❌ لا يمكنك تنزيل اداري  الامر للمدير فقط.") 
        end 
        channel_demote(channel_id, "user#id"..user_id, ok_cb, false) 
        if result.from.username then 
            text = "@"..result.from.username.."اوف حب تم تنزيله من اداره البوت😢" 
        else 
            text = "[ "..user_id.." ] تم ☑️ تنزيلك من اداره البوت" 
        end 
    ...
    elseif get_cmd == "رفع المدير" then 
        ...
        local channel_id = 'channel#id'..result.to.peer_id 
            ...
            if result.from.username then 
                text = "@"..result.from.username.." [ "..result.from.peer_id.." ]   تم ☑️ رفعك مدير 😎البوت  " 
            else 
                text = "[ "..result.from.peer_id.." ]   تم ☑️ رفعك مدير 😎 البوت  " 
            end 
            send_large_msg(channel_id, text) 
        end 
...
send_large_msg(receiver, "["..user_id.."] 😯تم راح الكتم عنه😊😊😄 ") 
        elseif is_admin1(msg) then 
            mute_user(chat_id, user_id) 
            send_large_msg(receiver, " ["..user_id.."] 👌يا فاشل من وره لغوتك كتمك😇") 
        end 
    end 
end 
...
local function cb_user_info(extra, success, result) 
    ...
    if get_cmd == "تنزيل اداري" then 
        ...
        if result.username then 
            text = "@"..result.username.."   خطيه تم تزيله من الاداره😇😢 " 
            send_large_msg(receiver, text) 
        else 
            text = "[ "..result.peer_id.." ]   خطيه تم تنزيله من الاداره😇😢  " 
            send_large_msg(receiver, text) 
        end 
    elseif get_cmd == "رفع ادمن" then 
        if result.username then 
...
local function callbackres(extra, success, result) 
  ...
  elseif get_cmd == "invite" then 
    ...
    elseif get_cmd == "تنزيل اداري" then 
        ...
        if result.username then 
            text = "@"..result.username.." خطيه تم تنزيله من الاداره😢" 
            send_large_msg(channel_id, text) 
        else 
            text = "@"..result.peer_id.."   خطيه تم تنزيله من الاداره😢 " 
            send_large_msg(channel_id, text) 
    ...
    if vusername == member or vpeer_id == memberid then 
     ...
     local sender = cb_extra.msg.from.id 
      ...
      if is_momod2(user_id, channel_id) and not is_admin2(sender) then 
        return send_large_msg("channel#id"..channel_id, "❌ لاتكمز بكيفك لا يمكن طرد الادمن او المدير😆️") 
      end 
      if is_admin2(user_id) then 
        return send_large_msg("channel#id"..channel_id, "❌ لا تكمز بكيفك لا يمكن طر 😆الادمن او المدير️") 
      end 
      if v.username then 
        text = "" 
...
elseif get_cmd == "رفع اداري" then 
   for k,v in pairs(result) do 
    ...
    if vusername == member or vpeer_id == memberid then 
      ...
      channel_set_admin(channel_id, user_id, ok_cb, false) 
      if v.username then 
        text = "@"..v.username.." ["..v.peer_id.."]   تم رفعته في اداره البوت كبد عمري😆  " 
        savelog(msg.to.id, name_log.." ["..msg.from.id.."] set admin @"..v.username.." ["..v.peer_id.."]") 
      else 
        text = "["..v.peer_id.."]   تم رفعته في اداره البوت كبد عمري😆 " 
    ...
    for k,v in pairs(result) do 
        ...
        if vusername == member or vpeer_id == memberid then 
            ...
            if group_owner then 
                ...
                if result.username then 
                    text = member_username.." ["..v.peer_id.."]  تم رفعته مدير البوت 😈 كبدي  " 
                else 
                    text = "["..v.peer_id.."]  تم رفعته مدير البوت 😈 كبدي  " 
                end 
            end 
        elseif memberid and vusername ~= member and vpeer_id ~= memberid then 
            ...
            if group_owner then 
                ...
                text = "["..memberid.."] تم رفعته مدير البوت 😈 كبدي " 
            end 
        end 
    end 
 end 
    ...
    local data = load_data(_config.moderation.data) 
        if matches[1] == 'تفعيل' and not matches[2] then 
            ...
            if is_super_group(msg) then 
                return reply_msg(msg.id, 'عزيزي المطور \n  @'..msg.from.username..'\n  بل فعل انه مجموعه\n '..msg.to.title..'\n مفعله مسبقا😇', ok_cb, false) 
            end 
...
return "مدير المجموعه  ["..group_owner..']' 
        end 
        ...
        if matches[1] == "كشف بوت" and is_momod(msg) then 
            member_type = 'تم ☑️ الكشف عن  بوتات في المجموعه ' 
        ...
        if matches[1] == 'تغير الرابط' and is_momod(msg)then 
            ...
            local receiver = get_receiver(msg) 
                if success == 0 then 
                    send_large_msg(receiver, 'عذرٱ ️لا يمكنك 🚫تغيير الرابط \nالمجموعه 👥 ليست من صنع البوت\n\nيرجئ استخدام ️الرابط الخاص بها في اعدادات المجموعه🚶') 
                    data[tostring(msg.to.id)]['settings']['set_link'] = nil 
                    save_data(_config.moderation.data, data) 
                else 
                    send_large_msg(receiver, "تم ☑️ تغير الرابط  حبي") 
        ...
        if msg.text then 
            if msg.text:match("^(https://telegram.me/joinchat/%S+)$") and data[tostring(msg.to.id)]['settings']['set_link'] == 'waiting' and is_owner(msg) then 
                ...
                save_data(_config.moderation.data, data) 
                return "تم ☑️ حفظ الرابط #الاضهار_الرابط_ارسل_كلمه الرابط" 
            end 
        end 
        ...
        if matches[1] == 'رفع ادمن' then 
          if not is_momod(msg) then 
            ...
            if not is_owner(msg) then 
                return " لتلعب بكيفك  فقط الادمنيه  يحق لهم ذالك " 
            end 
            if type(msg.reply_id) ~= "nil" then 
                local cbreply_extra = { 
                    get_cmd = 'رفع ادمن', 
        ...
        if matches[1] == 'تنزيل ادمن' then 
            ...
            if not is_owner(msg) then 
                return "️ لتلعب بكيفك  فقط الادمنيه  يحق لهم ذالك " 
            end 
            if type(msg.reply_id) ~= "nil" then 
                local cbreply_extra = { 
                    get_cmd = 'تنزيل ادمن', 
    ...
    --@pl_pl-- 
        ...
        if matches[1] == 'مسح' then 
            ...
            if not is_momod(msg) then 
                return "لا تلعب بكيفك هذا الامر للمدير 😉️" 
            end 
            if matches[2] == 'الادمنيه' then 
                if next(data[tostring(msg.to.id)]['moderators']) == nil then 
                    return 'عذرا لا يوجد ادمنيه لمسحهم😠' 
                end 
                for k,v in pairs(data[tostring(msg.to.id)]['moderators']) do 
            ...
            if matches[2] == 'الوصف' then 
                ...
                local data_cat = 'description' 
                if data[tostring(msg.to.id)][data_cat] == nil then 
                    return 'عذرٱ ️ لا يوجد وصف  في المجموعه  ليتم مسح' 
                end 
                data[tostring(msg.to.id)][data_cat] = nil 
                save_data(_config.moderation.data, data) 
